...
This package contains some extensions to the [Akka.Net](http://getakka.net/) F# APIs. [![NuGet](https://img.shields.io/badge/nuget-v0.1.0.3-blue.svg)](https://www.nuget.org/packages/Akka.NET.FSharp.API.Extensions/)
